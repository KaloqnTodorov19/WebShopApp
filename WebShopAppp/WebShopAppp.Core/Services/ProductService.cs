...
namespace WebShopAppp.Core.Services
{
    public class ProductService : IProductService
    {
        ...
        public List<Product> GetProducts(string searchStringCategoryName, string searchStringBrandName)
        {
            ...
            {
                products = products.Where(x => x.Category.CategoryName.ToLower().Contains(searchStringCategoryName.ToLower()) && x.Brand.BrandName.ToLower().Contains(searchStringBrandName)).ToList();
            }
